...
const mCssvalue = m.ofCss<CssSelector1, CssPropertyType1>({
    cssSelector: ['active1'],
    cssProperty: [{
...
const vVariableValue = M.ofVariable<NodeValue, Variable>({
    variable: {
        test: {
            variable: {
                black: '#000',
...
type VariableProp = t.base.PVariable<NodeValue, t.VariableProp, 'color' | 'backgroundColor'>;

type AbbrsProps1 = t.base.AbbrProp<'PH', t.TCssProperty, 'marginLeft'>;
const abbrs1 = M.ofAbbr<t.TCssProperty, AbbrsProps1>({ PH: ['marginLeft', 'marginRight'] });
