...
import { IProperty, PCssProperty, PCssSelector,  PCss } from './type';
...
const template = (i: number = 0) => <P>(node: PCss<P> | PCss<P>[]): string => {
    if (isArray(node)) {
...
${indent(i)}}`;
/**
 * convert PCss object to css's string
 */
