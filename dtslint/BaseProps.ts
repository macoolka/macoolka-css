import { BaseProps,CssNode,CssSelector } from '../src/base';
...
// $ExpectError
const p4: CssNode<BaseProps> = { width: 10 }
/**
 * CssPseudos
 */
...
// $ExpectError
const selector2: CssSelector<BaseProps> = { ':focus': { width: 10 } }
...
// $ExpectError
const e1: CssNode<BaseProps>  = { width: 10 }
...
// $ExpectError
const e4: CssNode<BaseProps>  = { color: 'red', width: 10 }
